...
Destinazione: `https://www.gioriva.it/quotazero/`

---

## Il nome

Quota zero è il punto da cui tutto comincia: il suolo. È lì che si studia la
teoria, si legge il METAR, si verificano le zone geografiche e si decide se il
volo si fa. Il portale racconta proprio quel momento, non quello successivo.

Il nome funziona anche come contrappunto alla scala altimetrica che attraversa
tutto il progetto, dalle zone geografiche colorate all'indicatore dell'hero: se
il tetto della categoria Open è 120 metri, quota zero è l'altro estremo, quello
da cui si parte.

Il payoff lo completa senza ripeterlo: il volo comincia a terra.

Una nota per il futuro. Nel settore droni italiano il nome era libero al momento
della scelta, ma fuori dal settore esistono omonimi con una presenza online
consistente: un forum ligure di escursionismo attivo dal 2005, un massetto
edilizio della Laterlite e un paio di società registrate. Nessuno di questi
crea conflitto su gioriva.it, ma vale la pena saperlo se un domani volessi
registrare il marchio o comprare un dominio dedicato.

---

## Pubblicazione

Copia l'intera cartella in `gioriva.it/quotazero/`. Non serve build,
...
| Cosa | Dove |
|---|---|
| Sito | `https://www.gioriva.it/quotazero/` |
| Foto e video | `https://gioriva.github.io/album/quotazero/` |
