#!/usr/bin/env python3
"""Quota Zero · immagine di anteprima social 1200x630.
...
FR = "/home/claude/quotazero/design/fonts/"
...
tracked(d, (CX, 96 * S), "GIORIVA.IT  /  QUOTAZERO", f_eti, (*GRIGIO, 195), 4.6, anchor="ms")
...
w1 = d.textlength("Quota", font=f_tit)
w2 = d.textlength("Zero", font=f_tit_c)
gap = 26 * S
x0 = CX - (w1 + gap + w2) / 2
y_tit = 296 * S
d.text((x0, y_tit), "Quota", font=f_tit, fill=CARTA, anchor="ls")
d.text((x0 + w1 + gap, y_tit), "Zero", font=f_tit_c, fill=OTTONE_CHI, anchor="ls")
...
img.resize((W, H), Image.LANCZOS).save(
    "/home/claude/quotazero/og-quotazero.jpg", "JPEG", quality=90, optimize=True, progressive=True)
print("og-quotazero.jpg", W, "x", H)
