...
function vistaPercorso(k) {
  ...
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Percorso <b>' + esc(p.sigla) + '</b></span><span>' + mods.length + ' moduli</span><span>circa <b>' + Math.round(min / 60 * 10) / 10 + ' ore</b> di studio</span></div>';
...
function vistaArea(k) {
  ...
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Area tematica</span><span>' + mods.length + (mods.length === 1 ? ' modulo' : ' moduli') + '</span></div>';
...
function vistaGlossario() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Riferimento</span><span>' + GLOSSARIO.length + ' voci</span></div>';
...
function vistaMetar() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Strumento</span><span>METeorological Aerodrome Report</span></div>';
...
function vistaEsame(k) {
  ...
  var n = k === 'a2' ? 30 : 40;
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Simulazione</span><span>' + n + ' domande</span><span>60 minuti</span><span>soglia <b>75%</b></span></div>';
...
function vistaContatti() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Contatti</span></div>';
...
function montaContatti() {
  ...
  f.addEventListener('submit', function (e) {
    ...
    dati.append('_subject', 'Quota Zero · messaggio da ' + $('#c-nome').value.trim() + ' ' + $('#c-cognome').value.trim());
...
function vistaPrivacy() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Quota Zero</a><span>Informativa</span><span>Reg. UE <b>2016/679</b></span></div>';
