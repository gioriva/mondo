...
function vistaHome() {
  ...
  ['a1a3', 'a2'].forEach(function (k) {
    ...
    var fatti = mods.filter(function (m) { return Progresso.fatto(m.id); }).length;
    h += '<a class="percorso" href="' + p.pagina + '">';
    ...
    h += '<div class="piede"><span>' + mods.length + ' moduli</span><span><b>' + fatti + '</b> superati</span></div></a>';
  });
  h += '</div></section>';
  ...
  h += '<section class="blocco" id="come"><div class="blocco-testa"><h2>Come si <em>arriva</em> all\'attestato</h2><span class="riga"></span><p>Due percorsi distinti, con adempimenti diversi. Il secondo parte dove finisce il primo.</p></div>';
  h += '<div class="passi">';
  ...
  var sottotitolo = { a1a3: 'Il primo passo, per chiunque', a2: 'Il livello successivo, per la classe C2' };

  ['a1a3', 'a2'].forEach(function (k) {
    var p = PERCORSI[k];
    h += '<div class="passo-carta">';
    h += '<div class="passo-testa"><span class="passo-sigla">' + p.sigla.replace('/', '<span>/</span>') + '</span>';
    h += '<h3>' + esc(sottotitolo[k]) + '</h3></div>';
  ...
  h += '</div>';
  h += '<div class="nota italia" style="max-width:72ch;margin-left:auto;margin-right:auto"><span class="eyebrow">Prima di ogni volo</span><p>Attestato valido, registrazione operatore attiva, copertura assicurativa, zone geografiche verificate su D-Flight, meteo controllato. Cinque voci, due minuti.</p></div>';
  h += '</div></section>';
...
function vistaPercorso(k) {
  ...
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Percorso <b>' + esc(p.sigla) + '</b></span><span>' + mods.length + ' moduli</span><span>circa <b>' + Math.round(min / 60 * 10) / 10 + ' ore</b> di studio</span></div>';
...
function vistaArea(k) {
  ...
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Area tematica</span><span>' + mods.length + (mods.length === 1 ? ' modulo' : ' moduli') + '</span></div>';
...
function vistaGlossario() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Riferimento</span><span>' + GLOSSARIO.length + ' voci</span></div>';
...
function vistaMetar() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Strumento</span><span>METeorological Aerodrome Report</span></div>';
...
function vistaEsame(k) {
  ...
  var n = k === 'a2' ? 30 : 40;
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Simulazione</span><span>' + n + ' domande</span><span>60 minuti</span><span>soglia <b>75%</b></span></div>';
...
function vistaContatti() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Contatti</span></div>';
  ...
  h += '<a href="https://www.gioriva.it" target="_blank" rel="noopener">' + ico('marchio') + '<span>gioriva.it</span></a>';
  h += '</div></aside>';
...
function montaContatti() {
  ...
  f.addEventListener('submit', function (e) {
    ...
    dati.append('_subject', 'Ground School · messaggio da ' + $('#c-nome').value.trim() + ' ' + $('#c-cognome').value.trim());
...
function vistaPrivacy() {
  var h = '<header class="hero hero-corto"><div class="hero-sfondo" aria-hidden="true"></div><div class="hero-inner">';
  h += '<div class="strip-coord"><a href="index.html">Ground School</a><span>Informativa</span><span>Reg. UE <b>2016/679</b></span></div>';
