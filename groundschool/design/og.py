#!/usr/bin/env python3
"""Ground School · immagine di anteprima social 1200x630.
...
FR = "/home/claude/groundschool/design/fonts/"
...
tracked(d, (CX, 96 * S), "GIORIVA.IT  /  GROUNDSCHOOL", f_eti, (*GRIGIO, 195), 4.6, anchor="ms")
...
w1 = d.textlength("Ground", font=f_tit)
w2 = d.textlength("School", font=f_tit_c)
gap = 26 * S
x0 = CX - (w1 + gap + w2) / 2
y_tit = 296 * S
d.text((x0, y_tit), "Ground", font=f_tit, fill=CARTA, anchor="ls")
...
img.resize((W, H), Image.LANCZOS).save(
    "/home/claude/groundschool/og-groundschool.jpg", "JPEG", quality=90, optimize=True, progressive=True)
print("og-groundschool.jpg", W, "x", H)
