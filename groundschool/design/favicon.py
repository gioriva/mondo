#!/usr/bin/env python3
"""Ground School · segno ridotto e favicon.
...
# ------------------------------------------------------------------ SVG
svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="Ground School">
