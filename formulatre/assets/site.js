/* Formula Tre | Le stagioni di Tarcisio Riva | script condiviso */
(function () {
  "use strict";
  ...
  function mostraPagina(p, scorri) {
    ...
    for (var idx = inizio; idx < fine; idx++) {
      (function (i) {
        ...
        img.alt = "Tarcisio Riva in monoposto, foto " + (i + 1);
  ...
  function aggiornaVisore() {
    ...
    img.alt = "Tarcisio Riva in monoposto, foto " + (indiceCorrente + 1) + " di " + FOTO.length;
