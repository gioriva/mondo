...
Destinazione: `https://www.gioriva.it/droneschool/`

---

## Il nome

*Ground school* è il termine con cui l'aviazione chiama da sempre la parte teorica
che si studia prima di salire in volo. Drone School ne conserva la costruzione ma
dice subito di cosa si tratta, senza chiedere a chi arriva da una ricerca di
conoscere il gergo aeronautico. Si scrive in un modo solo, non va tradotto e
funziona bene anche come indirizzo.

Il payoff *Il volo comincia a terra* recupera il significato che il nome originale
portava nella prima parola.

---

## Pubblicazione

Copia l'intera cartella in `gioriva.it/droneschool/`. Non serve build,
...
| Cosa | Dove |
|---|---|
| Sito | `https://www.gioriva.it/droneschool/` |
| Foto e video | `https://gioriva.github.io/album/droneschool/` |
