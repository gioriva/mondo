#!/usr/bin/env python3
"""Drone School · primitive di disegno condivise.
...
FR_DIR = "/home/claude/droneschool/design/fonts/"
...
def firma(d, ss, w, h, testo="DRONE SCHOOL · GIORIVA.IT/DRONESCHOOL", m=54):
