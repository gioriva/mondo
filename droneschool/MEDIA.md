# Media del portale Drone School
...
```
https://gioriva.github.io/album/droneschool/
```
...
| File | Uso |
|---|---|
| `og-droneschool.jpg` | Anteprima di condivisione 1200x630, richiamata dai meta tag |
| `og-droneschool.png` | Stessa immagine senza compressione, se ti serve altrove |
