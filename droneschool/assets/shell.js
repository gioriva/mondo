/* ==========================================================================
   Drone School · guscio comune: logo, menu, piede, consenso
...
function costruisciTestata(attivo) {
  var h = '';
  h += '<a class="marchio" href="index.html" aria-label="Drone School, torna alla home">';
  h += '<span class="marchio-segno">' + ICONE.marchio + '</span>';
  h += '<span class="marchio-testo">Drone <em>School</em></span></a>';
...
function costruisciPiede() {
  ...
  h += '<p class="disclaimer">Drone School è materiale di studio non ufficiale, redatto a partire dal programma teorico europeo per la categoria Open. Non sostituisce i testi ENAC né la documentazione applicabile, che resta l\'unico riferimento valido. Le zone geografiche vanno sempre verificate su D-Flight prima di ogni volo. La normativa cambia: se una data o un numero non coincidono con quanto pubblicato dall\'autorità, vale l\'autorità.</p>';
